...
const SERVICES = [
  {
    ...
    description: "We engineer how your business looks and feels across every touchpoint. Logo, colour system, typography, brand guide, and tone of voice — all aligned to attract the exact clients you want.",
  ...
  },
  {
    ...
    description: "Your website should close enquiries while you're unavailable. We build fast, mobile-optimised websites designed around your buyer's journey — not just to look good.",
  ...
  },
  {
    ...
    description: "We create and manage your social media content so your audience grows and your brand stays visible — without you spending hours on it daily.",
  ...
  },
  {
    ...
    description: "We build a simple, powerful CRM pipeline and sales dashboard for your business so you always know exactly where every prospect is and what action to take next.",
...
// ── HOW WE WORK ───────────────────────────────────────────────────────────────
const STEPS = [
  { num: "01", title: "Get Clarity", short: "Tell us where you are and where you want to go", detail: "You speak to one of our strategists — or use the Get Clarity chat — and we ask the right questions. We listen for what you actually need, not just what you asked for. Most founders discover two or three gaps they hadn't considered." },
  { num: "02", title: "We Audit You", short: "Brand, visibility, and systems — assessed", detail: "We review your current brand, website, social presence, and sales process. Within 48 hours we produce a clear picture of your biggest growth blockers and where focused investment will move the needle most." },
  { num: "03", title: "You Approve", short: "Scoped plan — tools, timeline, investment", detail: "We present a written scope of work: exactly what we will build, in what order, using which tools, and what it costs. You approve the plan before any work begins. No surprises at any stage." },
  { num: "04", title: "We Build", short: "Brand, website, systems — professionally executed", detail: "Our brand designers, developers, and systems specialists execute the plan. You receive regular progress updates. We handle every technical detail — you focus on running your business." },
  { num: "05", title: "We Hand Over", short: "Documented, trained, live — you own everything", detail: "Deliverables are handed over with full documentation and a training session. Every asset is in your name. Every system is documented so your team can manage it. We remain available for 30 days post-delivery." },
];
  ...
  return (
    <div className="min-h-screen text-[#2C2C2C]" style={{ backgroundColor: Cr }}>
      <PageMeta
        ...
        description="Brand identity, website design, automation and SEO for growing businesses. Abuja, FCT."
      />
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-[56px] flex items-center justify-between">
          <div className="flex items-center gap-5">
            <span className="font-semibold tracking-[2px] text-sm" style={{ color: G }}>
              SYSTEMIZE
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/systemise/cto">
              <span className="text-xs font-medium uppercase tracking-[1px] transition-opacity hover:opacity-60 cursor-pointer"
                style={{ color: `${G}70` }}>
                CTO
              </span>
            </Link>
            <button
              onClick={() => openChat()}
              className="px-5 py-2 rounded-lg text-xs font-medium uppercase tracking-[1px] transition-all hover:-translate-y-0.5"
          ...
          <button
            onClick={() => openChat()}
            className="md:hidden px-4 py-2 rounded-lg text-xs font-medium uppercase tracking-[1px]"
            style={{ backgroundColor: Au, color: G }}
          >
            Get Clarity
          </button>
      ...
      <section id="my-update" className="py-20 md:py-28" style={{ backgroundColor: W }}>
        <div className="max-w-xl mx-auto px-5 text-center">
          ...
          <p className="text-[14px] opacity-60 mb-8" style={{ color: G }}>Enter your tracking reference to access your project status.</p>

          <div className="flex gap-2 mb-4">
            <div className="flex items-center rounded-2xl border px-4 font-mono text-[14px] shrink-0"
              style={{ borderColor: "rgba(10,31,28,0.12)", backgroundColor: Cr, color: `${G}70` }}>
              HAM-26-
            </div>
            <input type="text" value={trackCode} onChange={(e) => handleTrackInput(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && handleTrack()}
              placeholder="00-0000" maxLength={7}
              className="flex-1 rounded-2xl px-4 py-3.5 text-[14px] outline-none border font-mono"
              style={{ borderColor: "rgba(10,31,28,0.12)", backgroundColor: Cr, color: G }} />
          ...
          <p className="text-[11px] opacity-40 mb-6 font-mono" style={{ color: G }}>Format: HAM-26-XX-XXXX</p>
          ...
          {trackSubmitted && !trackQuery.isFetching && trackQuery.data && (
            <>
              {trackQuery.data.found ? (
                ...
                <p className="text-[13px] opacity-60" style={{ color: G }}>No file found. Contact your project manager.</p>
              )}
            </>
          )}
        </div>
      ...
      <section className="py-20 px-5 text-center" style={{ backgroundColor: G }}>
        <div className="max-w-2xl mx-auto">
          ...
          <button onClick={() => openChat()}
            className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl text-[14px] font-semibold transition-all hover:-translate-y-1"
            style={{ backgroundColor: Au, color: G }}>
      ...
      <nav className="fixed bottom-0 inset-x-0 md:hidden z-50 flex items-center justify-around h-16 border-t"
        style={{ backgroundColor: W, borderColor: `${G}08` }}>
        ...
        <button onClick={() => { document.getElementById("my-update")?.scrollIntoView({ behavior: "smooth" }); }}
          className="flex flex-col items-center gap-1 text-[10px] font-semibold opacity-50 hover:opacity-100 transition-opacity uppercase tracking-wider"
          style={{ color: G }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C9A97E" strokeWidth="1.5"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
          My Update
        </button>
      </nav>
    </div>
